...
➸ *${prefix}ttp*
Text to sticker contoh : ${prefix}ttp Xuuujuuu
➸ *${prefix}tts*
Suara google contoh : ${prefix}tts id Hallo Xuuujuuu
➸ *${prefix}toimg*
Reply sticker yang mau dijadiin image
➸ *${prefix}nulis*
Untuk menulis dibuku
➸ *${prefix}stalkig*
Stalking instagram contoh : ${prefix}stalkig Xuuujuuu
➸ *${prefix}quotes*
Random quotes
➸ *${prefix}bikinquote*
Membuat quotes contoh : ${prefix}bikinquote Kamu gay & Xuuujuuu
➸ *${prefix}play*
...
➸ *${prefix}hartatahta*
Membuat lomgo, contoh : ${prefix}hartatahta Maya
➸ *${prefix}pornhub*
Membuat logo, contoh : ${prefix}pornhub Xuuujuuu & Hub
